...
else ifneq ($(filter q6aq%, $(TARGET_PRODUCT)),)
PRODUCT_COPY_FILES += vendor/qcom/opensource/power/config/pineapple/powerhint_q6aq.xml:$(TARGET_COPY_OUT_VENDOR)/etc/powerhint.xml
else
